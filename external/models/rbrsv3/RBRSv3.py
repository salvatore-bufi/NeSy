...
from .RBRSv3Model import RBRSv3Model
from elliot.recommender.recommender_utils_mixin import RecMixin
from elliot.recommender.base_recommender_model import init_charger


class RBRSv3(RecMixin, BaseRecommenderModel):
    r"""
    Rule Based RS
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = RBRSv3Model(num_users=self._num_users, num_items=self._num_items, learning_rate=self._learning_rate,
