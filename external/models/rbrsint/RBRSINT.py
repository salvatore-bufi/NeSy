...
from .RBRSINTModel import RBRSINTModel
from elliot.recommender.recommender_utils_mixin import RecMixin
from elliot.recommender.base_recommender_model import init_charger


class RBRSINT(RecMixin, BaseRecommenderModel):
    r"""
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = RBRSINTModel(num_users=self._num_users, num_items=self._num_items, learning_rate=self._learning_rate,
