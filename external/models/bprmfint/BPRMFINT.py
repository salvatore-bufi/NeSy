...
from .BPRMFINTModel import BPRMFINTModel
from elliot.recommender.recommender_utils_mixin import RecMixin
from elliot.recommender.base_recommender_model import init_charger


class BPRMFINT(RecMixin, BaseRecommenderModel):
    r"""
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = BPRMFINTModel(self._num_users,
                                    self._num_items,
                                    self._learning_rate,
                                    self._factors,
                                    self._l_w,
